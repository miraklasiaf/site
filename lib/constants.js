...
export const ORG_NAME = 'Miraklasiaf'
export const PLATFORM_LOWERCASE = 'miraklasiaf'
export const PLATFORM_CDN_NAME = 'Miraklasiaf Edge Network'
export const PLATFORM_URL = 'https://miraklasiaf.now.sh'

export const links = [
  [Twitter, 'https://twitter.com/miraklasiaf'],
  [Github, 'https://github.com/miraklasiaf'],
  [Mail, 'mailto:faisalkarim96@gmail.com'],
]
